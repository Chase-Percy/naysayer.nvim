...
function M.get()
	return {
		...
		OctoViewer = { fg = C.darkest_green, bg = C.blue },
		...
		OctoBubbleYellow = { fg = C.darkest_green, bg = C.yellow },
		OctoBubbleDelimiterYellow = { fg = C.yellow },
		OctoBubbleRed = { fg = C.darkest_green, bg = C.red },
		...
		OctoStateClosed = { fg = C.red, bg = C.darkest_green },
		OctoStateClosedFloat = { fg = C.red, bg = C.darkest_green },
