...
function M.get()
	return {
		LeapMatch = {
			fg = O.transparent_background and C.monokai_magenta or U.vary_color({ latte = "#222222" }, U.brighten(C.green, 0.3)),
		...
		LeapLabelSecondary = {
			...
			bg = O.transparent_background and C.none or U.vary_color({ latte = U.brighten(C.monokai_blue, 0.3) }, C.monokai_blue),
			style = { "nocombine", O.transparent_background and "bold" or nil },
		},
