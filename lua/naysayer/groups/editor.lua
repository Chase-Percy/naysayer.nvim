...
function M.get()
	return {
		...
		LineNr = {fg = U.blend(C.grey, O.transparent_background and "#000000" or C.darkest_green,  0.1) }, -- Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
		CursorLineNr = { fg = C.white, style = { "bold" } }, -- Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line. highlights the number in numberline.
