...
function M.get()
	return {
		...
		LineNr = {M.blend(C.grey, 0.1, O.transparent_background and C.none or C.darkest_green) }, -- Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
