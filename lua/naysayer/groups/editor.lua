...
function M.get()
	return {
		...
		LineNr = {fg = U.blend(C.grey, O.transparent_background and "#000000" or C.darkest_green,  0.65) }, -- Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
