...
function M.get()
	return {
		...
		LineNr = {fg = U.blend(C.grey, O.transparent_background and C.grey or C.darkest_green,  0.1) }, -- Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
